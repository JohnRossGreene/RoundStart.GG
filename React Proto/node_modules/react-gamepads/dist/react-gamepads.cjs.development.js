...
var GamepadsContext = /*#__PURE__*/React.createContext({});
...
var GamepadsProvider = function GamepadsProvider(_ref) {
  ...
  var requestRef = React.useRef();
  var haveEvents = ('ongamepadconnected' in window);
  var addGamepad = React.useCallback(function (gamepad) {
    var _extends2;
  ...
  var scanGamepads = React.useCallback(function () {
    // Grab gamepads from browser API
    var detectedGamepads = navigator.getGamepads ? navigator.getGamepads() : navigator.webkitGetGamepads ? navigator.webkitGetGamepads() : []; // Loop through all detected controllers and add if not already in state
  ...
  return React__default.createElement(GamepadsContext.Provider, {
    value: {
      gamepads: gamepads,
...
exports.GamepadsContext = GamepadsContext;
exports.GamepadsProvider = GamepadsProvider;
exports.useGamepads = useGamepads;
//# sourceMappingURL=react-gamepads.cjs.development.js.map
